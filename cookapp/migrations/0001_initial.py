    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='nutrition', to='cookapp.ingredient')),
            ],
        ),
        migrations.CreateModel(
            name='Recipe',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_ingredients', to='cookapp.ingredient')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_ingredients', to='cookapp.recipe')),
            ],
        ),
        migrations.CreateModel(
            name='UserRequest',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grocery_items', to='cookapp.ingredient')),
            ],
            options={
                'ordering': ['-updated_on'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meal_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meal_recipes', to='cookapp.mealplan')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meal_plans', to='cookapp.recipe')),
            ],
            options={
